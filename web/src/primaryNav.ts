  ...
  return `
    <aside class="left-nav code-left-nav" aria-label="Primary">
      ...
      <div class="left-nav-actions">
        <button class="nav-icon-button" type="button" title="Chat Map" aria-label="Chat Map" aria-haspopup="menu" aria-expanded="false" data-nav="map"><span class="codicon codicon-map"></span></button>
