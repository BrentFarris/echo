...
// actual execution is handled by the chat session (it must pause the turn for
...
// ask_user_questions tool arguments. The chat host parses it into the session
// question-set type sent to the UI.
